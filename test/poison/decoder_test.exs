defmodule Poison.DecoderTest do
  ...
  test "decoding using remapping with camel case string keys" do
    ...
    assert decode(contact2, as: %Contact2{}) == %Poison.DecoderTest.Contact2{ call_count: 7, email: "abc@123" }
  end

  test "decoding using remapping with camel case atom keys" do
    contact2 = %{ :callCount => 7, :email => "abc@123" }
    assert decode(contact2, as: %Contact2{}, keys: :atoms) == %Poison.DecoderTest.Contact2{ call_count: 0, email: "abc@123" }
  end
